...
public :
   ...
   Float_t         jtm[maxEntry];   //[nref]
   Float_t         discr_fr01[maxEntry];   //[nref]
   Float_t         trackMax[maxEntry];   //[nref]
   Float_t         trackSum[maxEntry];   //[nref]
   Int_t           trackN[maxEntry];   //[nref]
   Float_t         trackHardSum[maxEntry];   //[nref]
   Int_t           trackHardN[maxEntry];   //[nref]
   Float_t         chargedMax[maxEntry];   //[nref]
   Float_t         chargedSum[maxEntry];   //[nref]
   Int_t           chargedN[maxEntry];   //[nref]
   Float_t         chargedHardSum[maxEntry];   //[nref]
   Int_t           chargedHardN[maxEntry];   //[nref]
   Float_t         photonMax[maxEntry];   //[nref]
   Float_t         photonSum[maxEntry];   //[nref]
   Int_t           photonN[maxEntry];   //[nref]
   Float_t         photonHardSum[maxEntry];   //[nref]
   Int_t           photonHardN[maxEntry];   //[nref]
   Float_t         neutralMax[maxEntry];   //[nref]
   Float_t         neutralSum[maxEntry];   //[nref]
   Int_t           neutralN[maxEntry];   //[nref]

   Float_t         hcalSum[maxEntry];   //[nref]
   Float_t         ecalSum[maxEntry];   //[nref]

   Float_t         eMax[maxEntry];   //[nref]
   Float_t         eSum[maxEntry];   //[nref]
   Int_t           eN[maxEntry];   //[nref]
   Float_t         muMax[maxEntry];   //[nref]
   Float_t         muSum[maxEntry];   //[nref]
   Int_t           muN[maxEntry];   //[nref]
   Float_t         matchedPt[maxEntry];   //[nref]
   Float_t         matchedR[maxEntry];   //[nref]
   Int_t           beamId1;
   Int_t           beamId2;
   Float_t         pthat;
   ...
   Int_t           refparton_flavorForB[maxEntry];   //[nref]

   Float_t         genChargedSum[maxEntry];   //[nref]
   Float_t         genHardSum[maxEntry];   //[nref]

   Float_t         signalChargedSum[maxEntry];   //[nref]
   Float_t         signalHardSum[maxEntry];   //[nref]

   Int_t           subid[maxEntry];   //[nref]
