...
// Wed Jan 23 06:08:30 2013 by ROOT version 5.32/00
// from TTree HltTree/
...
class Hlts {
 ...
 public :
   ...
   Int_t           NL1IsolEm;
   Float_t         L1IsolEmEt[MaxNumber];   //[NL1IsolEm]
   Float_t         L1IsolEmE[MaxNumber];   //[NL1IsolEm]
   Float_t         L1IsolEmEta[MaxNumber];   //[NL1IsolEm]
   Float_t         L1IsolEmPhi[MaxNumber];   //[NL1IsolEm]
   Int_t           NL1NIsolEm;
   Float_t         L1NIsolEmEt[MaxNumber];   //[NL1NIsolEm]
   Float_t         L1NIsolEmE[MaxNumber];   //[NL1NIsolEm]
   Float_t         L1NIsolEmEta[MaxNumber];   //[NL1NIsolEm]
   Float_t         L1NIsolEmPhi[MaxNumber];   //[NL1NIsolEm]
   Int_t           NL1Mu;
   Float_t         L1MuPt[MaxNumber];   //[NL1Mu]
   Float_t         L1MuE[MaxNumber];   //[NL1Mu]
   Float_t         L1MuEta[MaxNumber];   //[NL1Mu]
   Float_t         L1MuPhi[MaxNumber];   //[NL1Mu]
   Int_t           L1MuIsol[MaxNumber];   //[NL1Mu]
   Int_t           L1MuMip[MaxNumber];   //[NL1Mu]
   Int_t           L1MuFor[MaxNumber];   //[NL1Mu]
   Int_t           L1MuRPC[MaxNumber];   //[NL1Mu]
   Int_t           L1MuQal[MaxNumber];   //[NL1Mu]
   Int_t           L1MuChg[MaxNumber];   //[NL1Mu]
   Int_t           NL1CenJet;
   Float_t         L1CenJetEt[MaxNumber];   //[NL1CenJet]
   Float_t         L1CenJetE[MaxNumber];   //[NL1CenJet]
   Float_t         L1CenJetEta[MaxNumber];   //[NL1CenJet]
   Float_t         L1CenJetPhi[MaxNumber];   //[NL1CenJet]
   Int_t           NL1ForJet;
   Float_t         L1ForJetEt[MaxNumber];   //[NL1ForJet]
   Float_t         L1ForJetE[MaxNumber];   //[NL1ForJet]
   Float_t         L1ForJetEta[MaxNumber];   //[NL1ForJet]
   Float_t         L1ForJetPhi[MaxNumber];   //[NL1ForJet]
   Int_t           NL1Tau;
   Float_t         L1TauEt[MaxNumber];   //[NL1Tau]
   Float_t         L1TauE[MaxNumber];   //[NL1Tau]
   Float_t         L1TauEta[MaxNumber];   //[NL1Tau]
   Float_t         L1TauPhi[MaxNumber];   //[NL1Tau]
   Float_t         L1Met;
   Float_t         L1MetPhi;
   Float_t         L1EtTot;
   Float_t         L1Mht;
...
void setupHltTree(TTree *t,Hlts &tHlts,bool doCheck = 0)
{
  ...
  t->SetBranchAddress("HLT_Jet60_v1", &tHlts.HLT_Jet60_v1, &tHlts.b_HLT_Jet60_v1);
